...
\\
I de två första iterationerna nyttjade gruppen Scrum i kombination med stories som Kniberg förespråkat. Undersökningsmetodens första och andra cykel visade att detta fungerade bra, men att det var något svårt att koppla uppgifter till användarkrav och det blev lite väl mycket ad-hoc. I början av sprint tre blev gruppen introducerad till use-cases Jacobson. Fördelar sågs i use-cases och de prövades tillsammans med stories i iteration 3, i samband med detta så började ett närmare sammarbete mellan projektledare och kravansvarig då båda parter arbetade med use-cases, men på olika sätt projektledare för att organisera arbetet och kravansvarig för att fånga krav. Detta samarbetande rönte framgång och i undersökningscykel tre och fyra arbetade gruppen igenom fler storypoints än i de tidigare iterationerna, även fast arbetstiden var kortare.

//

Under hela projektgenomförandet agerade Scrum med inslag av KanBan som huvudmetod. Stories har använts i konjuktion med use-cases som blivit uppdelade i use-case slices, detta för att organisera arbetet och bryta ned kraven som kravansvarig tagit fram i tillräckligt så delar så att de går att skapa ett iterationsmål för kravet och sedan arbeta mot detta mål.I detta avseende har jag som projektledare jobbat tätt ihop med kravansvarig, som använt stories och use-cases för att fånga in krav i arbete.

Kniberg \cite{Kniberg07} förespråkar stories medan Jacobson \cite{Jacobson11} förespråkar use-cases. Jag ser fördelar i båda metoderna och valde därför att kombinera dessa, då jag anser att use-cases och stories går lite hand i hand, men use-cases har födelen att det på ett strukturerat sätt går att dela upp dem i mindre delar i form av slices. Denna kombination har gett gruppen möjlighet att nyttja typiska delar av Scrum så som story points, burn-down charts och tasks, men på samma gång få stabiliteten ifrån Essence och dela upp arbetet på ett väldigt elegant sätt genom use-cases och slices. De delar av projektet som ej kunnat kopplas till något use-case har blivit så kallade ``tech-stories'' som helt enkelt är en metod för att hantera overhead, vilket är ofrånkomligt i ett projekt där en del av projektet avhandlar lärandet av projektmetodiker, som så är fallet i denna kurs.
...
komponent fungerar internet, utan snarare om hur de samarbetar och tillsammans
uppfyller kraven.
