...
\newcolumntype{"}{@{\hskip0\tabcolsep\vrule width 1pt\hskip\tabcolsep}}
\makeatother
...
\begin{center}
	\small
	\centering
	\begin{tabu} to \columnwidth {"X[l]"X[l]"X[l]"l|}
    \thickhline
    \taburowcolors[1]1{Gray..Gray}
    \multicolumn{4}{"c|}{"Keep"} \\
    \thickhline
    "Keep" & Motivation & Förbättringar & Referenser \\
    \thickhline
    \taburowcolors[1]1{white..white}
    Use-Cases \& Slices & Use-Cases är fångar in krav på ett intuitiv\\
    \thickhline
    Scrum & Scrum organiserar IT-arbete på ett sätt som passar många utvecklare och beställare. Den iterativa processen tillåter kontinuerlig utvär \\
    \thickhline
    Projekttavla & Projekttavlan fungerar som en tydlig \\
    \thickhline
    \end{tabu}
\end{center}
